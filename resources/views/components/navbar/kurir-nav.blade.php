    ...
    <div class="px-4 py-3 flex items-center justify-between">
        <div class="flex items-center">
            ...
            <button id="sidebar-toggle" type="button"
                class="inline-flex items-center p-2 text-orange-600 bg-white rounded-lg lg:hidden hover:bg-orange-100 focus:outline-none focus:ring-2 focus:ring-orange-400 transition-all duration-200 shadow">
...
<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-56 h-screen pt-20 bg-gradient-to-b from-orange-400 via-orange-500 to-orange-200 shadow-lg flex flex-col items-center transition-transform duration-300 -translate-x-full lg:translate-x-0"
    aria-label="Sidebar">
