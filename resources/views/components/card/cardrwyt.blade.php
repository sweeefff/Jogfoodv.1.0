<div class="bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
    ...
    <div class="p-4 flex">
        <div class="w-16 h-16 border rounded overflow-hidden flex-shrink-0">
            <img src="{{ asset('assets/img/menu/' . $gambar_menu) }}" alt="{{ $nama }}" class="w-full h-full object-cover">
        </div>
    ...
    <div class="p-4 border-t">
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('detail', $id_menu) }}"><button class="bg-orange-500 text-white px-6 py-2 rounded">Lihat Detail Menu</button></a>
