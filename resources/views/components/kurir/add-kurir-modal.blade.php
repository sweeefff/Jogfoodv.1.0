        ...
        <form action="{{ route('kurir.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block font-medium mb-1 text-gray-700">Username <span class="text-red-500">*</span></label>
                        <input type="text" name="username" class="w-full border rounded px-3 py-2" required>
                    </div>
                    <div>
                        <label class="block font-medium mb-1 text-gray-700">Nama Lengkap <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        ...
                        <!-- Tampilan visual untuk user -->
                        <input type="text" value="kurir" readonly class="w-full border rounded px-3 py-2 bg-gray-100">
                        <!-- Hidden field yang benar-benar dikirim -->
