        ...
        <div class="flex-1 overflow-auto p-6 bg-gray-50">
            <div class="max-w-6xl mx-auto">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <button
                        class="px-4 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-colors">
                            ...
                            <div class="flex flex-col items-center">
                                <div class="relative mb-4">
                                    <img id="avatar-preview"
                                        ...
                                        src="https://images.unsplash.com/photo-1517248135467-4dbc1a6e0e5b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
                                        alt="Restaurant">
                                    <label for="avatar-upload"
                                        class="absolute bottom-0 right-0 bg-amber-500 text-white p-2 rounded-full cursor-pointer avatar-upload hover:bg-amber-600">
                                        <i class="fas fa-camera"></i>
                                        <input type="file" id="avatar-upload" accept="image/*" class="hidden">
                                    </label>
                                </div>
                                <h2 class="text-xl font-semibold text-gray-800">Jogfood</h2>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="bg-white rounded-lg shadow custom-shadow p-6 mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 h-32">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>
                            </div>
                        </div>
                        ...
                        <div class="bg-white rounded-lg shadow custom-shadow p-6 mb-6">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
                                    value="123 Gourmet Street, Foodville, CA 90210">
                            </div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex-1 flex items-center space-x-2">
                                        <input type="time" class="px-2 py-1 border border-gray-300 rounded-md"
                                            value="11:00">
                                        <span>-</span>
                                        <input type="time" class="px-2 py-1 border border-gray-300 rounded-md"
                                            value="22:00">
                            ...
                            <div class="space-y-4 mb-6">
                                <div>
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text"
                                            class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-500"
                                            value="Jogfood">
                                    </div>
                                </div>
                            </div>
