...
<div class="flex flex-col flex-1 overflow-hidden pt-20 ml-64 min-h-screen bg-gray-50">
    <!-- Header -->
    <div class="flex flex-col md:flex-row items-center justify-between h-auto md:h-24 px-4 md:px-10 py-6 border-b border-gray-200 bg-white shadow-sm rounded-b-xl gap-4">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 md:p-8 flex-1">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="px-3 py-2 border border-gray-200 rounded-md bg-gray-50">{{ $admin->alamat ?? '-' }}</div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div class="px-3 py-2 border border-gray-200 rounded-md bg-gray-50">{{ $admin->role ?? 'admin' }}</div>
                </div>
            </div>
            <div class="mt-8">
                <h5 class="text-base md:text-lg font-semibold text-gray-700 mb-2">Tentang Admin</h5>
                <p class="text-gray-600 text-sm md:text-base">
                    Admin Jogfood bertugas mengelola data menu, pesanan, dan rekap penjualan di sistem Jogfood. Silakan hubungi admin jika ada kendala pada aplikasi.
                </p>
            </div>
        </div>
    </div>
