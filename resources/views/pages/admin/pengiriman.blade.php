    ...
    <div class="min-h-screen bg-amber-50 flex flex-col md:pl-64 pl-4 pr-4 md:pr-8 mt-20">
        ...
        <div class="flex-1 flex flex-col items-center justify-start pt-8 pb-8 md:pt-16 md:pb-16">
            <div class="w-full max-w-6xl bg-white p-4 md:p-8 rounded-xl shadow-lg">
                ...
                <!-- Form Pencarian -->
                <form method="GET" action="{{ route('admin.pengiriman') }}"
                    class="mb-6 flex flex-col md:flex-row gap-2 md:items-center justify-center">
                    ...
                    <button type="submit"
                        class="bg-amber-700 hover:bg-amber-800 text-white px-4 py-2 rounded-lg text-sm font-semibold transition">Cari</button>
                </form>
        ...
        <div class="relative w-full max-w-md mx-4 my-8 bg-white rounded-2xl shadow-2xl p-6 scale-95 opacity-0 transition-all duration-300"
            ...
            <form id="formPilihKurir" method="POST" action="">
                ...
                <div class="mb-5">
                    ...
                    <select name="kurir" id="id_kurir"
                        class="w-full border border-amber-300 rounded-lg px-3 py-2 text-sm focus:ring-amber-500 focus:border-amber-500 transition">
