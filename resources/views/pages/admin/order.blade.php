...
<div class="min-h-screen bg-amber-50 flex flex-col pt-4 md:pl-64 pl-4 pr-4 md:pr-8 mt-20">
    <div class="w-full max-w-screen-xl bg-white p-8 rounded-xl shadow-lg mx-auto">
        ...
        <form method="GET" action="{{ route('admin.order') }}" class="mb-8">
            <div class="flex flex-col md:flex-row md:items-end gap-4 bg-amber-100 p-4 rounded-lg shadow-sm border border-amber-200">
                <div>
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        <input type="text" id="date-range" class="border rounded px-2 py-1 text-sm bg-white min-w-[220px]" readonly
                ...
                <div>
                    ...
                    <select name="metode_pembayaran" class="border rounded px-2 py-1 text-sm bg-white min-w-[140px] w-40">
                        ...
                        <option value="Ewallet" {{ request('metode_pembayaran')=='Ewallet' ? 'selected' : '' }}>Ewallet</option>
                    </select>
                </div>
                <div class="flex gap-2">
                    <button type="submit" class="bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded font-semibold text-sm shadow">Filter</button>
        ...
        <div class="mb-4">
            <div class="bg-green-50 border border-green-200 rounded px-4 py-3 text-green-700 font-semibold text-lg flex items-center gap-2">
                            ...
                            <div class="p-4 rounded-lg bg-white shadow w-full max-w-3xl mx-auto">
                                ...
                                <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-bold text-amber-600">Rp{{ number_format($totalAkhir, 0, ',', '.') }}</span>
                                    </div>
                                    <div>
