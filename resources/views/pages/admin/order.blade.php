                    ...
                    <tbody class="text-gray-700 text-sm">
                        @forelse($transaksi as $order)
                            <tr class="border-b hover:bg-amber-50 transition">
                                ...
                                <td class="px-4 py-3">
                                    {{ \Carbon\Carbon::parse($order->tanggal_transaksi)->format('d M Y, H:i') }}
                                </td>
                                    ...
                                    <div class="p-4 rounded-lg bg-white shadow">
                                        <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="text-gray-600">{{ \Carbon\Carbon::parse($order->tanggal_transaksi)->format('d M Y, H:i') }}</span>
                                            </div>
                                            <div>
                                        ...
                                        <div class="mb-2">
                                            ...
                                            @else
                                                <span
                                                    class="badge bg-yellow-200 text-yellow-800">{{ $order->status_transaksi }}</span>
                                            @endif
                                        </div>
                                        <div class="mb-2">
