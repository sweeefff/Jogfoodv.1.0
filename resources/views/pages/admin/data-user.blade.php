                ...
                <table class="min-w-full bg-white border border-gray-200 text-sm text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50 text-center">
                            ...
                            <td class="px-3 py-2">
                                @if($user->foto)
                                    <img src="{{ asset('storage/user/' . $user->foto) }}" alt="Foto {{ $user->name }}" class="w-8 h-8 rounded-full object-cover mx-auto">
                                @else
                                    <span class="text-xs text-gray-400 italic">Tidak ada foto</span>
                                @endif
                            </td>
                            <td class="px-3 py-2">
                                <button onclick="confirmDelete('{{ route('users.destroy', $user->id) }}')" class="text-red-600 hover:text-red-800">
