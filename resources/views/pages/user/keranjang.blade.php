                ...
                <div class="p-6">
                    <div id="cart-items" class="space-y-4">
                        ...
                        <div class="cart-item flex items-center border border-amber-100 rounded-lg p-4 gap-4 bg-white">
                            <input type="checkbox"
                                class="item-checkbox w-5 h-5 text-amber-500 rounded focus:ring-amber-500 border-gray-400"
                                onchange="toggleButton()">
                            <div class="flex items-center gap-4 flex-1">
                                <div
                                    class="w-16 h-16 bg-amber-100 rounded-lg flex items-center justify-center overflow-hidden">
                                    <img src="https://images.unsplash.com/photo-1565557623262-b51c2513a641?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1074&q=80"
                            ...
                            <button onclick="removeItem(this)"
                                class="remove-btn bg-amber-500 hover:bg-amber-600 text-white text-sm px-3 py-1 rounded-lg transition">Hapus</button>
                        </div>
                        ...
                        <div class="cart-item flex items-center border border-amber-100 rounded-lg p-4 gap-4 bg-white">
                            ...
                            <div class="flex items-center gap-4 flex-1">
                                <div
                                    class="w-16 h-16 bg-amber-100 rounded-lg flex items-center justify-center overflow-hidden">
                                    <img src="https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80"
