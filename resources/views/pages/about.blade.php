...
@section('content')
  <div class="text-gray-800 font-sans antialiased">
    ...
    <div class="absolute inset-0">
      <img src="{{ asset('assets/img/jogja.webp') }}" alt="Tugu Jogja" class="w-full h-full object-cover opacity-30">
    ...
    <div class="relative z-10 container mx-auto px-6 flex flex-col items-center justify-center text-center">
      ...
      <a href="#profile"
      class="inline-block mt-12 px-8 py-3 bg-white text-orange-600 rounded-full font-semibold shadow hover:bg-orange-50 transition duration-300">
    ...
    <div class="flex flex-col md:flex-row items-center gap-12">
      <div class="md:w-1/2">
      <img src="{{ asset('assets/img/jogja2.jpeg') }}" alt="Jogja Culinary"
      ...
      <p class="text-lg leading-relaxed text-gray-600 mb-6">
        JogFood adalah platform kuliner yang membantu wisatawan dan warga lokal menemukan hidden gem kuliner terbaik
        di Yogyakarta. Kami hadir untuk mempermudah kamu menjelajahi cita rasa khas Jogja.
      </p>
      <p class="text-lg leading-relaxed text-gray-600">
        Dari angkringan legendaris hingga resto modern dengan nuansa khas, kami menyajikan rekomendasi terbaik
        berdasarkan pengalaman nyata para food hunter.
      </p>
      </div>
    </div>
    </section>
    ...
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="flex gap-6">
        ...
        <p class="text-gray-600">Menjembatani antara pecinta kuliner dengan tempat makan autentik di Jogja yang
          mungkin belum banyak diketahui.</p>
        </div>
      </div>
      ...
      <div class="flex gap-6">
        ...
        <p class="text-gray-600">Membantu usaha kecil dan menengah di bidang kuliner untuk dikenal lebih luas oleh
          masyarakat.</p>
        </div>
      </div>
      ...
      <div class="flex gap-6">
        ...
        <p class="text-gray-600">Menyajikan ulasan jujur dan rekomendasi terbaik berdasarkan pengalaman nyata para
          reviewer.</p>
        </div>
      </div>
    ...
    <div class="max-w-6xl mx-auto px-6">
      ...
      <div class="bg-white p-8 rounded-2xl shadow-md flex flex-col items-center">
        <div class="w-20 h-20 rounded-full bg-orange-100 flex items-center justify-center mb-4 overflow-hidden">
        <img src="{{ asset('assets/img/ruth.jpeg') }}" alt="Ruth Yohana Manurung"
      ...
      <div class="bg-white p-8 rounded-2xl shadow-md flex flex-col items-center">
        <div class="w-20 h-20 rounded-full bg-orange-100 flex items-center justify-center mb-4 overflow-hidden">
        <img src="{{ asset('assets/img/josepine.jpeg') }}" alt="Josepine Stevie Hia"
          class="w-full h-full object-cover">
        </div>
      ...
      <div class="bg-white p-8 rounded-2xl shadow-md flex flex-col items-center">
        <div class="w-20 h-20 rounded-full bg-orange-100 flex items-center justify-center mb-4 overflow-hidden">
        <img src="{{ asset('assets/img/muhammad.jpeg') }}" alt="Muhammad Rizky Raapi Ramadhan"
          class="w-full h-full object-cover">
        </div>
