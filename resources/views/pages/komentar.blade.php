    ...
    <body>
        <div class="bg-gray-50 min-h-screen font-sans">
            ...
            <div class="max-w-4xl mx-auto px-4 py-8 space-y-6">
                <!-- Comment 1 -->
                <div
                    class="bg-white rounded-lg shadow-md p-6 border border-orange-100 hover:shadow-lg transition-shadow duration-200">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-2">
                                The Gudeg here is absolutely delicious! The flavors are perfectly balanced between sweet and
                                savory. The meat was so tender it practically melted in my mouth. Highly recommend!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <!-- Comment Text -->
                            <p class="text-gray-600 mt-2">
                                Best Gudeg I've ever had! The portion size was generous and the price was very reasonable.
                                The atmosphere of the place was also very cozy and traditional. Will definitely come back!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6 border border-orange-100">
                    ...
                    <form>
                        ...
                        <button type="submit"
                            class="bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-6 rounded-md transition-colors duration-200">
                            Submit Review
                        </button>
                    </form>
                </div>
