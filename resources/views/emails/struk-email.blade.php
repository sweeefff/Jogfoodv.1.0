...
<body
    style="margin:0;padding:0;background:#f3f4f6;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;color:#374151;">
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="600"
                    ...
                    <tr>
                        <td style="background:#ea580c;padding:18px 0;text-align:center;">
                            ...
                            <p style="color:#fdba74;font-size:13px;margin:4px 0 0;">© 2025 JogFood. Jl. Malioboro No.
                                123, Yogyakarta</p>
                        </td>
                    </tr>
                </table>
